...
function AstrologerCard({ id, photo, name, specialization, rating, experience, orders, price, discount, language }) {
         ...
         <Link  to={`/consultant-major-details/${id}`}>
            ...
            >
               ...
               <Box sx={{ position: "relative", mr: 3, height: "100%" }}>
                  <Avatar
                     src={photo || "https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=150&h=150&fit=crop&crop=face"}
                     alt="Astrologer"
                     sx={{
                        width: 80,
                        height: 80,
